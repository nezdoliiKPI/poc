...
public record ProducerConfigUpdate(
    ...
    @Max(value = 3000, message = "Field 'airJsonCount' cannot exceed 5000")
    ...
    @Max(value = 3000, message = "Field 'airProtoCount' cannot exceed 5000")
    ...
    @Max(value = 3000, message = "Field 'powerJsonCount' cannot exceed 5000")
    ...
    @Max(value = 3000, message = "Field 'powerProtoCount' cannot exceed 5000")
    ...
    @Max(value = 3000, message = "Field 'smokeJsonCount' cannot exceed 5000")
    ...
    @Max(value = 3000, message = "Field 'smokeProtoCount' cannot exceed 5000")
